...
<html lang="en">
	...
	<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
            <div class="container">
                <a class="navbar-brand" href="#!">WELCOME TO SCASA BY OSO SOLUTION SDN. BHD.</a>
        ...
        <header class="masthead text-center text-white">
            <div class="masthead-content">
                <div class="container">
                    <h1 class="masthead-heading mb-0">SMART CONTACTLESS ATTENDANCE SYSTEM USING ARDUINO </h1>
                    <h2 class="masthead-subheading mb-0">( S C A S A )</h2>
