<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	else
	{
		...
		<script>
          alert('Invalid User!!');
          window.location='/SCASA/login.jsp';
        </script>
		<%
	}
	%>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/SCASA/StaffController?action=viewStaffList">Staffs List</a>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                 Present (Daily)</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"> <c:out value="${attendance}" /> </div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Absent (Daily)</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><c:out value="${absent_staff}" /></div>
                                        </div>
                                        <div class="col-auto">
...
<!--                         <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Highest Temperature
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Total of Staffs</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"> <c:out value="${total_staff}" /></div>
                                        </div>
                                        <div class="col-auto">
...
<%--                     <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Staffs Temperature Overview (Monthly)</h6>
                            ...
                            <div class="card shadow mb-12">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Staffs Attendance Overview (Monthly)</h6>
                                </div>
                                <div class="card-body">
                                    <div class="chart-bar">
    ...
    <script src="/SCASA/js/demo/chart-area-demo1.js"></script>
    <script src="/SCASA/js/demo/chart-bar-demo.js"></script>
