...
public class Admin {
	...
	private String astaffid; 		// Admin Password 
	...
	//.......................   ADMIN DATABASE DECLARATIONN   ........................//
	
	public Admin(int adminid, int hodid, String role,String aname, String agender, String anotel,String aemail,
			String adepartment, String aposition, String anric, String arfid,String astatus,String astartdate, String apassword, String astaffid) {
		super();
	...
	//.......................   ADMIN DATABASE DECLARATIONN (WITHOUT HOD ID)   ........................//
	
	public Admin(int adminid, String role,String aname, String agender, String anotel,String aemail,
			String adepartment, String aposition, String anric, String arfid,String astatus,String astartdate, String apassword,String astaffid) {
		super();
		this.adminid 	= adminid;
		this.role 		= role;
	...
	//.......................   ADMIN DATABASE DECLARATIONN (WITHOUT ADMIN ID & HOD ID)   ........................//
	
	public Admin( String role,String aname, String agender, String anotel,String aemail,
			String adepartment, String aposition, String anric, String arfid,String astatus,String astartdate, String apassword,String astaffid) {
		super();
	...
	//.......................   ADMIN DATABASE DECLARATIONN (WITHOUT ADMIN ID & PASSWORD)   ........................//
	
	public Admin(int hodid, String role,String aname, String agender, String anotel,String aemail,
			String adepartment, String aposition, String anric, String arfid,String astatus,String astartdate, String astaffid) {
		super();
	...
	//.......................   ADMIN DATABASE DECLARATIONN  ADMIN ID & PASSWORD)   ........................//
